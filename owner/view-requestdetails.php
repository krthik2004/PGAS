...
if (strlen($_SESSION['pgasoid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    if ($ressta == 'Confirmed') {
      $roomsQuery = mysqli_query($con, "UPDATE tblpg SET norooms = norooms - (SELECT rooms FROM tblbookpg WHERE ID='$vid') WHERE ID = (SELECT Pgid FROM tblbookpg WHERE ID='$vid')");
  }
